...
Numerous sample programs can be found in @src/examples@.  They include clean, functional implementations of "Tetris":http://github.com/ztellman/penumbra/blob/master/src/examples/tetris.clj and "Asteroids":http://github.com/ztellman/penumbra/blob/master/src/examples/asteroids.clj, and a "Mandelbrot viewer":http://github.com/ztellman/penumbra/blob/master/src/examples/mandelbrot.clj that leverages the GPU.
